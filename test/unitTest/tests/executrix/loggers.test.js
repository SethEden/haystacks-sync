...
describe(tst_con.cconsoleLog, () => {
     ...
     * @description Tests the business rules function consoleLog with a invalid classPath string.
     * @author Json Howard
     * @date 2023/09/04
     */
     ...
     * @description Tests the business rules function consoleLog with a invalid message string.
     * @author Json Howard
     * @date 2023/09/04
     */
     ...
     * @description Tests the business rules function consoleLog with a invalid classPath integer.
     * @author Json Howard
     * @date 2023/09/04
     */
     ...
     * @description Tests the business rules function consoleLog with a invalid classPath boolean.
     * @author Json Howard
     * @date 2023/09/04
     */
     ...
     * @description Tests the business rules function consoleLog with a invalid message integer.
     * @author Json Howard
     * @date 2023/09/04
     */
     ...
     * @description Tests the business rules function consoleLog with a invalid message boolean.
     * @author Json Howard
     * @date 2023/09/04
     */
     ...
     * @description Tests the business rules function consoleLog with a invalid classPath undefined.
     * @author Json Howard
     * @date 2023/09/04
     */
     ...
     * @description Tests the business rules function consoleLog with a invalid classPath NaN.
     * @author Json Howard
     * @date 2023/09/04
     */
     ...
     * @description Tests the business rules function consoleLog with a invalid message undefined.
     * @author Json Howard
     * @date 2023/09/04
     */
     ...
     * @description Tests the business rules function consoleLog with a invalid message NaN.
     * @author Json Howard
     * @date 2023/09/04
     */
...
describe(tst_con.cconsoleTableLog, () => {
     ...
     * @description Tests the business rules function consoleTableLog with a valid input.
     * @author Json Howard
     * @date 2023/09/04
     */
     ...
     * @description Tests the business rules function consoleTableLog with a invalid classpath string.
     * @author Json Howard
     * @date 2023/09/04
     */
     ...
     * @description Tests the business rules function consoleTableLog with a invalid tableData string.
     * @author Json Howard
     * @date 2023/09/04
     */
     ...
     * @description Tests the business rules function consoleTableLog with a invalid columnNames string.
     * @author Json Howard
     * @date 2023/09/04
     */
     ...
     * @description Tests the business rules function consoleTableLog with a invalid classPath number.
     * @author Json Howard
     * @date 2023/09/04
     */
     ...
     * @description Tests the business rules function consoleTableLog with a invalid classPath boolean.
     * @author Json Howard
     * @date 2023/09/04
     */
     ...
     * @description Tests the business rules function consoleTableLog with a invalid classPath undefined.
     * @author Json Howard
     * @date 2023/09/04
     */
     ...
     * @description Tests the business rules function consoleTableLog with a invalid classPath NaN.
     * @author Json Howard
     * @date 2023/09/04
     */
     ...
     * @description Tests the business rules function consoleTableLog with a invalid tableData number.
     * @author Json Howard
     * @date 2023/09/04
     */
     ...
     * @description Tests the business rules function consoleTableLog with a invalid tableData boolean.
     * @author Json Howard
     * @date 2023/09/04
     */
     ...
     * @description Tests the business rules function consoleTableLog with a invalid tableData undefined.
     * @author Json Howard
     * @date 2023/09/04
     */
     ...
     * @description Tests the business rules function consoleTableLog with a invalid tableData NaN.
     * @author Json Howard
     * @date 2023/09/04
     */
     ...
     * @description Tests the business rules function consoleTableLog with a invalid columnNames Number.
     * @author Json Howard
     * @date 2023/09/04
     */
     ...
     * @description Tests the business rules function consoleTableLog with a invalid columnNames boolean.
     * @author Json Howard
     * @date 2023/09/04
     */
     ...
     * @description Tests the business rules function consoleTableLog with a invalid columnNames undefined.
     * @author Json Howard
     * @date 2023/09/04
     */
     ...
     * @description Tests the business rules function consoleTableLog with a invalid columnNames NaN.
     * @author Json Howard
     * @date 2023/09/04
     */
     ...
     * @description Tests the business rules function consoleTableLog with a invalid all undefined.
     * @author Json Howard
     * @date 2023/09/04
     */
     ...
     * @description Tests the business rules function consoleTableLog with a invalid all NaN.
     * @author Json Howard
     * @date 2023/09/04
     */
...
describe(tst_con.cconstantsValidationSummaryLog, () => {
     ...
     * @description Tests the business rules function constantsValidationSummaryLog with a valid input.
     * @author Json Howard
     * @date 2023/09/04
     */
     ...
     * @description Tests the business rules function constantsValidationSummaryLog with a invalid message string.
     * @author Json Howard
     * @date 2023/09/04
     */
     ...
     * @description Tests the business rules function constantsValidationSummaryLog with a invalid passFail string.
     * @author Json Howard
     * @date 2023/09/04
     */
     ...
     * @description Tests the business rules function constantsValidationSummaryLog with a invalid message integer.
     * @author Json Howard
     * @date 2023/09/04
     */
     ...
     * @description Tests the business rules function constantsValidationSummaryLog with a invalid message boolean.
     * @author Json Howard
     * @date 2023/09/04
     */
     ...
     * @description Tests the business rules function constantsValidationSummaryLog with a invalid passFail integer.
     * @author Json Howard
     * @date 2023/09/04
     */
     ...
     * @description Tests the business rules function constantsValidationSummaryLog with a invalid passFail boolean.
     * @author Json Howard
     * @date 2023/09/04
     */
     ...
     * @description Tests the business rules function constantsValidationSummaryLog with a invalid message undefined.
     * @author Json Howard
     * @date 2023/09/04
     */
     ...
     * @description Tests the business rules function constantsValidationSummaryLog with a invalid message NaN.
     * @author Json Howard
     * @date 2023/09/04
     */
     ...
     * @description Tests the business rules function constantsValidationSummaryLog with a invalid passFail undefined.
     * @author Json Howard
     * @date 2023/09/04
     */
     ...
     * @description Tests the business rules function constantsValidationSummaryLog with a invalid passFail NaN.
     * @author Json Howard
     * @date 2023/09/04
     */
...
describe(tst_con.cgetLogFileNameAndPath, () => {
     ...
     * @description Tests the business rules function getLogFileNameAndPath with a valid input.
     * @author Json Howard
     * @date 2023/09/04
     */
     ...
     * @description Tests the business rules function getLogFileNameAndPath with a invalid clientRootPath string.
     * @author Json Howard
     * @date 2023/09/04
     */
     ...
     * @description Tests the business rules function getLogFileNameAndPath with a invalid logFileName string.
     * @author Json Howard
     * @date 2023/09/04
     */
     ...
     * @description Tests the business rules function getLogFileNameAndPath with a invalid clientRootPath integer.
     * @author Json Howard
     * @date 2023/09/04
     */
     ...
     * @description Tests the business rules function getLogFileNameAndPath with a invalid clientRootPath boolean.
     * @author Json Howard
     * @date 2023/09/04
     */
     ...
     * @description Tests the business rules function getLogFileNameAndPath with a invalid logFileName integer.
     * @author Json Howard
     * @date 2023/09/04
     */
     ...
     * @description Tests the business rules function getLogFileNameAndPath with a invalid logFileName boolean.
     * @author Json Howard
     * @date 2023/09/04
     */
     ...
     * @description Tests the business rules function getLogFileNameAndPath with a invalid clientRootPath NaN.
     * @author Json Howard
     * @date 2023/09/04
     */
     ...
     * @description Tests the business rules function getLogFileNameAndPath with a invalid logFileName undefined.
     * @author Json Howard
     * @date 2023/09/04
     */
     ...
     * @description Tests the business rules function getLogFileNameAndPath with a invalid logFileName NaN.
     * @author Json Howard
     * @date 2023/09/04
     */
...
describe(tst_con.cprintMessageToFile, () => {
     ...
     * @description Tests the business rules function printMessageToFile with a valid input.
     * @author Json Howard
     * @date 2023/09/04
     */
     ...
     * @description Tests the business rules function printMessageToFile with a invalid file string.
     * @author Json Howard
     * @date 2023/09/04
     */
     ...
     * @description Tests the business rules function printMessageToFile with a invalid message string.
     * @author Json Howard
     * @date 2023/09/04
     */
     ...
     * @description Tests the business rules function printMessageToFile with a invalid file integer.
     * @author Json Howard
     * @date 2023/09/04
     */
     ...
     * @description Tests the business rules function printMessageToFile with a invalid file boolean.
     * @author Json Howard
     * @date 2023/09/04
     */
     ...
     * @description Tests the business rules function printMessageToFile with a invalid message integer.
     * @author Json Howard
     * @date 2023/09/04
     */
     ...
     * @description Tests the business rules function printMessageToFile with a invalid message boolean.
     * @author Json Howard
     * @date 2023/09/04
     */
     ...
     * @description Tests the business rules function printMessageToFile with a invalid file undefined.
     * @author Json Howard
     * @date 2023/09/04
     */
     ...
     * @description Tests the business rules function printMessageToFile with a invalid file NaN.
     * @author Json Howard
     * @date 2023/09/04
     */
     ...
     * @description Tests the business rules function printMessageToFile with a invalid message undefined.
     * @author Json Howard
     * @date 2023/09/04
     */
     ...
     * @description Tests the business rules function printMessageToFile with a invalid message NaN.
     * @author Json Howard
     * @date 2023/09/04
     */
