...
describe(tst_con.cgetNamedThemes, () => {
    ...
    * @description Tests the brokers themeBroker function getNamedThemes with a invalid string data.
    * @author Json Howard
    * @date 2023/04/17
    */
    ...
    * @description Tests the brokers themeBroker function getNamedThemes with a invalid number data.
    * @author Json Howard
    * @date 2023/04/17
    */
    ...
    * @description Tests the brokers themeBroker function getNamedThemes with a invalid boolean data.
    * @author Json Howard
    * @date 2023/04/17
    */
...
describe(tst_con.cgetNamedThemePath, () => {
    ...
    * @description Tests the brokers themeBroker function getNamedThemePath with a invalid string data.
    * @author Json Howard
    * @date 2023/04/17
    */
    ...
    * @description Tests the brokers themeBroker function getNamedThemePath with a invalid integer data.
    * @author Json Howard
    * @date 2023/04/17
    */
    ...
    * @description Tests the brokers themeBroker function getNamedThemePath with a invalid boolean data.
    * @author Json Howard
    * @date 2023/04/17
    */
...
describe(tst_con.cloadTheme, () => {
    ...
    * @description Tests the brokers themeBroker function loadTheme with a invalid string data.
    * @author Json Howard
    * @date 2023/04/17
    ...
    * @description Tests the brokers themeBroker function loadTheme with a invalid integer data.
    * @author Json Howard
    * @date 2023/04/17
    */
    ...
    * @description Tests the brokers themeBroker function loadTheme with a invalid boolean data.
    * @author Json Howard
    * @date 2023/04/17
    */
...
describe(tst_con.capplyTheme, () => {
    ...
    * @description Tests the brokers themeBroker function applyTheme with a invalid string data.
    ...
    * @description Tests the brokers themeBroker function applyTheme with a invalid integer data.
    * @author Json Howard
    * @date 2023/04/17
    */
    ...
    * @description Tests the brokers themeBroker function applyTheme with a invalid boolean data.
    * @author Json Howard
    * @date 2023/04/17
    */
