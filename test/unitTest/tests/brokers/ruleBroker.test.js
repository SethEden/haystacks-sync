...
describe(tst_con.cbootStrapBusinessRules, () => {
    ...
    * @description Tests the brokers.ruleBroker.bootStrapBusinessRules function, with a valid data.
    * @author Json Howard
    * @date 2023/04/17
    */
    ...
    * @description Tests the brokers.ruleBroker.bootStrapBusinessRules function, with an invalid string data.
    * @author Json Howard
    * @date 2023/04/17
    */
    ...
    * @description Tests the brokers.ruleBroker.bootStrapBusinessRules function, with an invalid number data.
    * @author Json Howard
    * @date 2023/04/17
    */
    ...
    * @description Tests the brokers.ruleBroker.bootStrapBusinessRules function, with an invalid boolean data.
    * @author Json Howard
    * @date 2023/04/17
    */
...
describe(tst_con.caddClientRules, () => {
    ...
    * @description Tests the brokers.ruleBroker.addClientRules function, with a valid data.
    * @author Json Howard
    * @date 2023/04/17
    */
    ...
    * @description Tests the brokers.ruleBroker.addClientRules function, with an invalid string data.
    * @author Json Howard
    * @date 2023/04/17
    */
    ...
    * @description Tests the brokers.ruleBroker.addClientRules function, with an invalid number data.
    * @author Json Howard
    * @date 2023/04/17
    */
    ...
    * @description Tests the brokers.ruleBroker.addClientRules function, with an invalid boolean data.
    * @author Json Howard
    * @date 2023/04/17
    */
...
describe(tst_con.cprocessRules, () => {
    ...
    * @description Tests the brokers.ruleBroker.processRules function, with a valid data.
    * @author Json Howard
    * @date 2023/04/17
    ...
    * @description Tests the brokers.ruleBroker.processRules function, with an invalid undefined data.
    * @author Json Howard
    * @date 2023/04/17
    */
    ...
    * @description Tests the brokers.ruleBroker.processRules function, with an invalid NaN data.
    * @author Json Howard
    * @date 2023/04/17
    */
    ...
    * @description Tests the brokers.ruleBroker.processRules function, with an invalid undefined rulesToExecute.
    * @author Json Howard
    * @date 2023/04/17
    */
    ...
    * @description Tests the brokers.ruleBroker.processRules function, with an invalid NaN rulesToExecute.
    * @author Json Howard
    * @date 2023/04/17
    */
    ...
    * @description Tests the brokers.ruleBroker.processRules function, with an invalid integer data.
    * @author Json Howard
    * @date 2023/04/17
    */
    ...
    * @description Tests the brokers.ruleBroker.processRules function, with an invalid boolean data.
    * @author Json Howard
    * @date 2023/04/17
    */
    ...
    * @description Tests the brokers.ruleBroker.processRules function, with an invalid integer rulesToExecute.
    * @author Json Howard
    * @date 2023/04/17
    */
    ...
    * @description Tests the brokers.ruleBroker.processRules function, with an invalid boolean rulesToExecute.
    * @author Json Howard
    * @date 2023/04/17
    */
