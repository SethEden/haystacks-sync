...
describe(tst_con.cprintDataHive, () => {
     ...
     * @description Tests the business rules function printDataHive with a valid input.
     * @author Json Howard
     * @date 2023/08/18
     */
     ...
     * @description Tests the business rules function printDataHive with a invalid input string.
     * @author Json Howard
     * @date 2023/08/18
     */
     ...
     * @description Tests the business rules function printDataHive with a invalid inputMetaData string.
     * @author Json Howard
     * @date 2023/08/18
     */
     ...
     * @description Tests the business rules function printDataHive with a invalid input integer.
     * @author Json Howard
     * @date 2023/08/18
     */
     ...
     * @description Tests the business rules function printDataHive with a invalid input boolean.
     * @author Json Howard
     * @date 2023/08/18
     */
     ...
     * @description Tests the business rules function printDataHive with a invalid inputMetaData integer.
     * @author Json Howard
     * @date 2023/08/18
     */
     ...
     * @description Tests the business rules function printDataHive with a invalid inputMetaData boolean.
     * @author Json Howard
     * @date 2023/08/18
     */
     ...
     * @description Tests the business rules function printDataHive with a invalid input undefined.
     * @author Json Howard
     * @date 2023/08/18
     */
     ...
     * @description Tests the business rules function printDataHive with a invalid input NaN.
     * @author Json Howard
     * @date 2023/08/18
     */
     ...
     * @description Tests the business rules function printDataHive with a invalid inputMetaData undefined.
     * @author Json Howard
     * @date 2023/08/18
     */
     ...
     * @description Tests the business rules function printDataHive with a invalid inputMetaData NaN.
     * @author Json Howard
     * @date 2023/08/18
     */
...
describe(tst_con.cprintDataHiveAttributes, () => {
     ...
     * @description Tests the business rules function printDataHiveAttributes with a valid input.
     * @author Json Howard
     * @date 2023/08/18
     */
     ...
     * @description Tests the business rules function printDataHiveAttributes with a invalid input string.
     * @author Json Howard
     * @date 2023/08/18
     */
     ...
     * @description Tests the business rules function printDataHiveAttributes with a invalid inputMetaData string.
     * @author Json Howard
     * @date 2023/08/18
     */
     ...
     * @description Tests the business rules function printDataHiveAttributes with a ivalid input integer.
     * @author Json Howard
     * @date 2023/08/18
     */
     ...
     * @description Tests the business rules function printDataHiveAttributes with a invalid input boolean.
     * @author Json Howard
     * @date 2023/08/18
     */
     ...
     * @description Tests the business rules function printDataHiveAttributes with a invalid inputMetaData integer.
     * @author Json Howard
     * @date 2023/08/18
     */
     ...
     * @description Tests the business rules function printDataHiveAttributes with a invalid inputMetaData boolean.
     * @author Json Howard
     * @date 2023/08/18
     */
     ...
     * @description Tests the business rules function printDataHiveAttributes with a invalid input undefined.
     * @author Json Howard
     * @date 2023/08/18
     */
     ...
     * @description Tests the business rules function printDataHiveAttributes with a invalid input NaN.
     * @author Json Howard
     * @date 2023/08/18
     */
     ...
     * @description Tests the business rules function printDataHiveAttributes with a invalid inputMetaData undefined.
     * @author Json Howard
     * @date 2023/08/18
     */
     ...
     * @description Tests the business rules function printDataHiveAttributes with a invalid inputMetaData NaN.
     * @author Json Howard
     * @date 2023/08/18
     */
...
describe(tst_con.cclearDataStorage, () => {
     ...
     * @description Tests the business rules function clearDataStorage with a valid input.
     * @author Json Howard
     * @date 2023/08/18
     */
     ...
     * @description Tests the business rules function clearDataStorage with a invalid input string.
     * @author Json Howard
     * @date 2023/08/18
     */
     ...
     * @description Tests the business rules function clearDataStorage with a invalid inputMetaData string.
     * @author Json Howard
     * @date 2023/08/18
     */
     ...
     * @description Tests the business rules function clearDataStorage with a invalid input integer.
     * @author Json Howard
     * @date 2023/08/18
     */
     ...
     * @description Tests the business rules function clearDataStorage with a invalid input boolean.
     * @author Json Howard
     * @date 2023/08/18
     */
     ...
     * @description Tests the business rules function clearDataStorage with a invalid inputMetaData integer.
     * @author Json Howard
     * @date 2023/08/18
     */
     ...
     * @description Tests the business rules function clearDataStorage with a invalid inputMetaData boolean.
     * @author Json Howard
     * @date 2023/08/18
     */
     ...
     * @description Tests the business rules function clearDataStorage with a invalid input undefined.
     * @author Json Howard
     * @date 2023/08/18
     */
     ...
     * @description Tests the business rules function clearDataStorage with a invalid input NaN.
     * @author Json Howard
     * @date 2023/08/18
     */
     ...
     * @description Tests the business rules function clearDataStorage with a invalid inputMetaData undefined.
     * @author Json Howard
     * @date 2023/08/18
     */
     ...
     * @description Tests the business rules function clearDataStorage with a invalid inputMetaData NaN.
     * @author Json Howard
     * @date 2023/08/18
     */
...
describe(tst_con.cchangeSetting, () => {
     ...
     * @description Tests the business rules function changeSetting with a valid input.
     * @author Json Howard
     * @date 2023/08/18
     */
     ...
     * @description Tests the business rules function changeSetting with a invalid input string.
     * @author Json Howard
     * @date 2023/08/18
     */
     ...
     * @description Tests the business rules function changeSetting with a invalid inputMetaData string.
     * @author Json Howard
     * @date 2023/08/18
     */
     ...
     * @description Tests the business rules function changeSetting with a invalid input integer.
     * @author Json Howard
     * @date 2023/08/18
     */
     ...
     * @description Tests the business rules function changeSetting with a invalid input boolean.
     * @author Json Howard
     * @date 2023/08/18
     */
     ...
     * @description Tests the business rules function changeSetting with a invalid inputMetaData integer.
     * @author Json Howard
     * @date 2023/08/18
     */
     ...
     * @description Tests the business rules function changeSetting with a invalid inputMetaData boolean.
     * @author Json Howard
     * @date 2023/08/18
     */
     ...
     * @description Tests the business rules function changeSetting with a invalid input undefined.
     * @author Json Howard
     * @date 2023/08/18
     */
     ...
     * @description Tests the business rules function changeSetting with a invalid input NaN.
     * @author Json Howard
     * @date 2023/08/18
     */
     ...
     * @description Tests the business rules function changeSetting with a invalid inputMetaData undefined.
     * @author Json Howard
     * @date 2023/08/18
     */
     ...
     * @description Tests the business rules function changeSetting with a invalid inputMetaData NaN.
     * @author Json Howard
     * @date 2023/08/18
     */
