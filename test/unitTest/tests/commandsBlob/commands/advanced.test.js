...
describe(tst_con.ccommandSequencer, () => {
  ...
  /**
     ...
     * @description Tests the commandsBlob.commands.advanced function commandSequencer with an invalid string input.
     * @author Json Howard
     * @date 2023/05/09
     */
 ...
 * @description Tests the commandsBlob.commands.advanced function commandSequencer with an invalid integer input.
 * @author Json Howard
 * @date 2023/05/09
 */
   ...
   * @description Tests the commandsBlob.commands.advanced function commandSequencer with an invalid boolean input.
   * @author Json Howard
   * @date 2023/05/09
   */
   ...
   * @description Tests the commandsBlob.commands.advanced function commandSequencer with an invalid undefined input.
   * @author Json Howard
   * @date 2023/05/09
   */
   ...
   * @description Tests the commandsBlob.commands.advanced function commandSequencer with an invalid NaN input.
   * @author Json Howard
   * @date 2023/05/09
   */
...
describe(tst_con.cworkflow, () => {
   ...
   * @description Tests the commandsBlob.commands.advanced function workflow with a valid input.
   * @author Json Howard
   * @date 2023/05/09
   */
   ...
   * @description Tests the commandsBlob.commands.advanced function workflow with an invalid string input.
   * @author Json Howard
   * @date 2023/05/09
   */
   ...
   * @description Tests the commandsBlob.commands.advanced function workflow with an invalid integer input.
   * @author Json Howard
   * @date 2023/05/09
   */
   ...
   * @description Tests the commandsBlob.commands.advanced function workflow with an invalid boolean input.
   * @author Json Howard
   * @date 2023/05/09
   */
   ...
   * @description Tests the commandsBlob.commands.advanced function workflow with an invalid undefined input.
   * @author Json Howard
   * @date 2023/05/09
   */
   ...
   * @description Tests the commandsBlob.commands.advanced function workflow with an invalid NaN input.
   * @author Json Howard
   * @date 2023/05/09
   */
...
describe(tst_con.cbusinessRule, () => {
   ...
   * @description Tests the commandsBlob.commands.advanced function businessRule with an invalid string input.
   * @author Json Howard
   * @date 2023/05/09
   */
   ...
   * @description Tests the commandsBlob.commands.advanced function businessRule with an invalid integer input.
   * @author Json Howard
   * @date 2023/05/09
   */
   ...
   * @description Tests the commandsBlob.commands.advanced function businessRule with an invalid boolean input.
   * @author Json Howard
   * @date 2023/05/09
   */
   ...
   * @description Tests the commandsBlob.commands.advanced function businessRule with an invalid undefined input.
   * @author Json Howard
   * @date 2023/05/09
   */
   ...
   * @description Tests the commandsBlob.commands.advanced function businessRule with an invalid NaN input.
   * @author Json Howard
   * @date 2023/05/09
   */
...
describe(tst_con.ccommandGenerator, () => {
  ...
  /**
     ...
     * @description Tests the commandsBlob.commands.advanced function commandGenerator with an invalid string input.
     * @author Json Howard
     * @date 2023/05/09
     */
   ...
   * @description Tests the commandsBlob.commands.advanced function commandGenerator with an invalid integer input.
   * @author Json Howard
   * @date 2023/05/09
   */
   ...
   * @description Tests the commandsBlob.commands.advanced function commandGenerator with an invalid boolean input.
   * @author Json Howard
   * @date 2023/05/09
   */
   ...
   * @description Tests the commandsBlob.commands.advanced function commandGenerator with an invalid undefined input.
   * @author Json Howard
   * @date 2023/05/09
   */
   ...
   * @description Tests the commandsBlob.commands.advanced function commandGenerator with an invalid NaN input.
   * @author Json Howard
   * @date 2023/05/09
   */
...
describe(tst_con.ccommandAliasGenerator, () => {
   ...
   * @description Tests the commandsBlob.commands.advanced function commandAliasGenerator with an invalid string input.
   * @author Json Howard
   * @date 2023/05/09
   */
   ...
   * @description Tests the commandsBlob.commands.advanced function commandAliasGenerator with an invalid integer input.
   * @author Json Howard
   * @date 2023/05/09
   */
   ...
   * @description Tests the commandsBlob.commands.advanced function commandAliasGenerator with an invalid boolean input.
   * @author Json Howard
   * @date 2023/05/09
   */
   ...
   * @description Tests the commandsBlob.commands.advanced function commandAliasGenerator with an invalid undefined input.
   * @author Json Howard
   * @date 2023/05/09
   */
   ...
   * @description Tests the commandsBlob.commands.advanced function commandAliasGenerator with an invalid NaN input.
   * @author Json Howard
   * @date 2023/05/09
   */
