...
describe(tst_con.cconstantGenerator, () => {
     ...
     * @description Tests the business rules function constantGenerator with a invalid input string.
     * @author Json Howard
     * @date 2023/08/18
     */
     ...
     * @description Tests the business rules function constantGenerator with a invalid inputMetaData string.
     * @author Json Howard
     * @date 2023/08/18
     */
     ...
     * @description Tests the business rules function constantGenerator with a invalid input integer.
     * @author Json Howard
     * @date 2023/08/18
     */
     ...
     * @description Tests the business rules function constantGenerator with a invalid input boolean.
     * @author Json Howard
     * @date 2023/08/18
     */
     ...
     * @description Tests the business rules function constantGenerator with a invalid inputMetaData integer.
     * @author Json Howard
     * @date 2023/08/18
     */
     ...
     * @description Tests the business rules function constantGenerator with a invalid inputMetaData boolean.
     * @author Json Howard
     * @date 2023/08/18
     */
     ...
     * @description Tests the business rules function constantGenerator with a invalid input undefined.
     * @author Json Howard
     * @date 2023/08/18
     */
     ...
     * @description Tests the business rules function constantGenerator with a invalid input NaN.
     * @author Json Howard
     * @date 2023/08/18
     */
     ...
     * @description Tests the business rules function constantGenerator with a invalid inputMetaData undefined.
     * @author Json Howard
     * @date 2023/08/18
     */
     ...
     * @description Tests the business rules function constantGenerator with a invalid inputMetaData NaN.
     * @author Json Howard
     * @date 2023/08/18
     */
...
describe(tst_con.cconstantsGeneratorList, () => {
     ...
     * @description Tests the business rules function constantsGeneratorList with a valid input.
     * @author Json Howard
     * @date 2023/08/18
     */
     ...
     * @description Tests the business rules function constantsGeneratorList with a invalid input string.
     * @author Json Howard
     * @date 2023/08/18
     */
     ...
     * @description Tests the business rules function constantsGeneratorList with a invalid inputMetaData string.
     * @author Json Howard
     * @date 2023/08/18
     */
     ...
     * @description Tests the business rules function constantsGeneratorList with a invalid input integer.
     * @author Json Howard
     * @date 2023/08/18
     */
     ...
     * @description Tests the business rules function constantsGeneratorList with a invalid input boolean.
     * @author Json Howard
     * @date 2023/08/18
     */
     ...
     * @description Tests the business rules function constantsGeneratorList with a invalid inputMetaData integer.
     * @author Json Howard
     * @date 2023/08/18
     */
     ...
     * @description Tests the business rules function constantsGeneratorList with a invalid inputMetaData boolean.
     * @author Json Howard
     * @date 2023/08/18
     */
     ...
     * @description Tests the business rules function constantsGeneratorList with a invalid input undefined.
     * @author Json Howard
     * @date 2023/08/18
     */
     ...
     * @description Tests the business rules function constantsGeneratorList with a invalid input NaN.
     * @author Json Howard
     * @date 2023/08/18
     */
     ...
     * @description Tests the business rules function constantsGeneratorList with a invalid inputMetaData undefined.
     * @author Json Howard
     * @date 2023/08/18
     */
     ...
     * @description Tests the business rules function constantsGeneratorList with a invalid inputMetaData NaN.
     * @author Json Howard
     * @date 2023/08/18
     */
...
describe(tst_con.cconstantsPatternRecognizer, () => {
     ...
     * @description Tests the business rules function constantsPatternRecognizer with a valid input.
     * @author Json Howard
     * @date 2023/08/18
     */
     ...
     * @description Tests the business rules function constantsPatternRecognizer with a invalid input string.
     * @author Json Howard
     * @date 2023/08/18
     */
     ...
     * @description Tests the business rules function constantsPatternRecognizer with a invalid inputMetaData string.
     * @author Json Howard
     * @date 2023/08/18
     */
     ...
     * @description Tests the business rules function constantsPatternRecognizer with a invalid input integer.
     * @author Json Howard
     * @date 2023/08/18
     */
     ...
     * @description Tests the business rules function constantsPatternRecognizer with a invalid input boolean.
     * @author Json Howard
     * @date 2023/08/18
     */
     ...
     * @description Tests the business rules function constantsPatternRecognizer with a invalid inputMetaData integer.
     * @author Json Howard
     * @date 2023/08/18
     */
     ...
     * @description Tests the business rules function constantsPatternRecognizer with a invalid inputMetaData boolean.
     * @author Json Howard
     * @date 2023/08/18
     */
     ...
     * @description Tests the business rules function constantsPatternRecognizer with a invalid input undefined.
     * @author Json Howard
     * @date 2023/08/18
     */
     ...
     * @description Tests the business rules function constantsPatternRecognizer with a invalid input NaN.
     * @author Json Howard
     * @date 2023/08/18
     */
     ...
     * @description Tests the business rules function constantsPatternRecognizer with a invalid inputMetaData undefined.
     * @author Json Howard
     * @date 2023/08/18
     */
     ...
     * @description Tests the business rules function constantsPatternRecognizer with a invalid inputMetaData NaN.
     * @author Json Howard
     * @date 2023/08/18
     */
...
describe(tst_con.cevaluateConstant, () => {
     ...
     * @description Tests the business rules function evaluateConstant with a valid input.
     * @author Json Howard
     * @date 2023/08/18
     */
     ...
     * @description Tests the business rules function evaluateConstant with a invalid input string.
     * @author Json Howard
     * @date 2023/08/18
     */
     ...
     * @description Tests the business rules function evaluateConstant with a invalid inputMetaData string.
     * @author Json Howard
     * @date 2023/08/18
     */
     ...
     * @description Tests the business rules function evaluateConstant with a invalid input integer.
     * @author Json Howard
     * @date 2023/08/18
     */
     ...
     * @description Tests the business rules function evaluateConstant with a invalid input boolean.
     * @author Json Howard
     * @date 2023/08/18
     */
     ...
     * @description Tests the business rules function evaluateConstant with a invalid inputMetaData integer.
     * @author Json Howard
     * @date 2023/08/18
     */
     ...
     * @description Tests the business rules function evaluateConstant with a invalid inputMetaData boolean.
     * @author Json Howard
     * @date 2023/08/18
     */
     ...
     * @description Tests the business rules function evaluateConstant with a invalid input undefined.
     * @author Json Howard
     * @date 2023/08/18
     */
     ...
     * @description Tests the business rules function evaluateConstant with a invalid input NaN.
     * @author Json Howard
     * @date 2023/08/18
     */
     ...
     * @description Tests the business rules function evaluateConstant with a invalid inputMetaData undefined.
     * @author Json Howard
     * @date 2023/08/18
     */
     ...
     * @description Tests the business rules function evaluateConstant with a invalid inputMetaData NaN.
     * @author Json Howard
     * @date 2023/08/18
     */
