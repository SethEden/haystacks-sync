...
describe(tst_con.cvalidateConstants, () => {
     ...
     * @description Tests the business rules function validateConstants with a valid input.
     * @author Json Howard
     * @date 2023/08/22
     */
     ...
     * @description Tests the business rules function validateConstants with a invalid input string.
     * @author Json Howard
     * @date 2023/08/22
     */
     ...
     * @description Tests the business rules function validateConstants with a invalid input undefined.
     * @author Json Howard
     * @date 2023/08/22
     */
...
describe(tst_con.cvalidateCommandAliases, () => {
     ...
     * @description Tests the business rules function validateCommandAliases with a valid input.
     * @author Json Howard
     * @date 2023/08/22
     */
     ...
     * @description Tests the business rules function validateCommandAliases with a invalid input duplicated.
     * @author Json Howard
     * @date 2023/08/22
     */
     ...
     * @description Tests the business rules function validateCommandAliases with a invalid input undefined.
     * @author Json Howard
     * @date 2023/08/22
     */
     ...
     * @description Tests the business rules function validateCommandAliases with a valid input NaN.
     * @author Json Howard
     * @date 2023/08/22
     */
...
describe(tst_con.cvalidateWorkflows, () => {
     ...
     * @description Tests the business rules function validateWorkflows with a valid input.
     * @author Json Howard
     * @date 2023/08/22
     */
     ...
     * @description Tests the business rules function validateWorkflows with a invalid input duplicated.
     * @author Json Howard
     * @date 2023/08/22
     */
     ...
     * @description Tests the business rules function validateWorkflows with a invalid input undefined.
     * @author Json Howard
     * @date 2023/08/22
     */
     ...
     * @description Tests the business rules function validateWorkflows with a invalid input NaN.
     * @author Json Howard
     * @date 2023/08/22
     */
