...
describe(tst_con.cprompt, () => {
   ...
   * @description Tests the business rules function prompt with a valid string input.
   * @author Json Howard
   * @date 2023/05/06
   */
   ...
   * @description Tests the business rules function prompt with a invalid string input.
   * @author Json Howard
   * @date 2023/05/06
   */
   ...
   * @description Tests the business rules function prompt with a invalid string inputMetaData.
   * @author Json Howard
   * @date 2023/05/06
   */
   ...
   * @description Tests the business rules function prompt with a invalid integer input.
   * @author Json Howard
   * @date 2023/05/06
   */
   ...
   * @description Tests the business rules function prompt with a invalid boolean input.
   * @author Json Howard
   * @date 2023/05/06
   */
