...
describe(tst_con.carraysAreEqual, () => {
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing function arraysAreEqual with an invalid string data.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing function arraysAreEqual with an invalid string inputMetaData.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing function arraysAreEqual with an invalid integer data.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing function arraysAreEqual with an invalid boolean data.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing function arraysAreEqual with an invalid integer inputMetaData.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing function arraysAreEqual with an invalid boolean inputMetaData.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing function arraysAreEqual with an invalid undefined data.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing function arraysAreEqual with an invalid NaN data.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing function arraysAreEqual with an invalid undefined inputMetaData.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing function arraysAreEqual with an invalid NaN inputMetaData.
    * @author Json Howard
    * @date 2023/04/19
    */
...
describe(tst_con.cstoreData, () => {
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.storeData function, with a valid data.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.storeData function, with an invalid string data.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.storeData function, with an invalid integer data.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.storeData function, with an invalid boolean data.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.storeData function, with an invalid integer inputMetaData.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.storeData function, with an invalid boolean inputMetaData.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.storeData function, with an invalid undefined inputMetaData.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.storeData function, with an invalid NaN inputMetaData.
    * @author Json Howard
    * @date 2023/04/19
    */
...
describe(tst_con.cgetStoredData, () => {
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.getStoredData function, with a valid data.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.getStoredData function, with an invalid string data.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.getStoredData function, with an invalid string inputMetaData.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.getStoredData function, with an invalid integer data.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.getStoredData function, with an invalid boolean data.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.getStoredData function, with an invalid integer inputMetaData.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.getStoredData function, with an invalid boolean inputMetaData.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.getStoredData function, with an invalid undefined data.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.getStoredData function, with an invalid NaN data.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.getStoredData function, with an invalid undefined inputMetaData.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.getStoredData function, with an invalid NaN inputMetaData.
    * @author Json Howard
    * @date 2023/04/19
    */
...
describe(tst_con.cisObjectEmpty, () => {
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.isObjectEmpty function, with a valid data.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.isObjectEmpty function, with an invalid string data.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.isObjectEmpty function, with an invalid string inputMetaData.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.isObjectEmpty function, with an invalid integer data.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.isObjectEmpty function, with an invalid boolean inputMetaData.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.isObjectEmpty function, with an invalid integer inputMetaData.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.isObjectEmpty function, with an invalid undefined data.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.isObjectEmpty function, with an invalid NaN data.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.isObjectEmpty function, with an invalid undefined inputMetaData.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.isObjectEmpty function, with an invalid NaN inputMetaData.
    * @author Json Howard
    * @date 2023/04/19
    */
...
describe(tst_con.cisArrayEmpty, () => {
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.isArrayEmpty function, with a valid data.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.isArrayEmpty function, with an invalid string data.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.isArrayEmpty function, with an invalid string inputMetaData.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.isArrayEmpty function, with an invalid integer data.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.isArrayEmpty function, with an invalid boolean data.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.isArrayEmpty function, with an invalid undefined data.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.isArrayEmpty function, with an invalid NaN data.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.isArrayEmpty function, with an invalid undefined inputMetaData.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.isArrayEmpty function, with an invalid NaN inputMetaData.
    * @author Json Howard
    * @date 2023/04/19
    */
...
describe(tst_con.cisObject, () => {
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.isObject function, with a valid object data.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.isObject function, with a valid array data.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.isObject function, with an invalid string data.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.isObject function, with an invalid integer data.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.isObject function, with an invalid boolean data.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.isObject function, with an invalid undefined data.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.isObject function, with an invalid NaN data.
    * @author Json Howard
    * @date 2023/04/19
    */
...
describe(tst_con.cisArray, () => {
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.isArray function, with a valid object data.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.isArray function, with a valid Array data.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.isArray function, with an invalid string data.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.isArray function, with an invalid integer data.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.isArray function, with an invalid boolean data.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.isArray function, with an invalid undefined data.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.isArray function, with an invalid NaN data.
    * @author Json Howard
    * @date 2023/04/19
    */
...
describe(tst_con.cisArrayOrObject, () => {
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.isArrayOrObject function, with a valid object data.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.isArrayOrObject function, with a valid array data.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.isArrayOrObject function, with an invalid string data.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.isArrayOrObject function, with an invalid integer data.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.isArrayOrObject function, with an invalid boolean data.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.isArrayOrObject function, with an invalid undefined data.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.isArrayOrObject function, with an invalid NaN data.
    * @author Json Howard
    * @date 2023/04/19
    */
...
describe(tst_con.cisNonZeroLengthArray, () => {
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.isNonZeroLengthArray function, with a valid object data.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.isNonZeroLengthArray function, with a valid array data.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.isNonZeroLengthArray function, with an invalid string data.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.isNonZeroLengthArray function, with an invalid integer data.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.isNonZeroLengthArray function, with an invalid boolean data.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.isNonZeroLengthArray function, with an invalid undefined data.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.isNonZeroLengthArray function, with an invalid naN data.
    * @author Json Howard
    * @date 2023/04/19
    */
...
describe(tst_con.carrayDeepClone, () => {
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.arrayDeepClone function, with a valid data.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.arrayDeepClone function, with a valid string data.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.arrayDeepClone function, with an invalid string inputMetaData.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.arrayDeepClone function, with an invalid integer data.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.arrayDeepClone function, with an invalid boolean data.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.arrayDeepClone function, with an invalid integer inputMetaData.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.arrayDeepClone function, with an invalid boolean inputMetaData.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.arrayDeepClone function, with an invalid undefined data.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.arrayDeepClone function, with an invalid NaN data.
    * @author Json Howard
    * @date 2023/04/19
    */
...
describe(tst_con.cobjectDeepMerge, () => {
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.objectDeepMerge function, with a valid data.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.objectDeepMerge function, with an invalid string data.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.objectDeepMerge function, with an invalid string inputMetaData.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.objectDeepMerge function, with an invalid integer data.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.objectDeepMerge function, with an invalid boolean data.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.objectDeepMerge function, with an invalid integer inputMetaData.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.objectDeepMerge function, with an invalid boolean inputMetaData.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.objectDeepMerge function, with an invalid undefined data.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.objectDeepMerge function, with an invalid NaN data.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.objectDeepMerge function, with an invalid undefined inputMetaData.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.objectDeepMerge function, with an invalid NaN inputMetaData.
    * @author Json Howard
    * @date 2023/04/19
    */
...
describe(tst_con.cgetNamespacedDataObject, () => {
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.getNamespacedDataObject function, with a valid data.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.getNamespacedDataObject function, with an invalid string inputMetaData.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.getNamespacedDataObject function, with an invalid string data.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.getNamespacedDataObject function, with an invalid integer data.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.getNamespacedDataObject function, with an invalid boolean data.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.getNamespacedDataObject function, with an invalid integer inputMetaData.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.getNamespacedDataObject function, with an invalid boolean inputMetaData.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.getNamespacedDataObject function, with an invalid undefined data.
    * @author Json Howard
    * @date 2023/04/19
    */
...
describe(tst_con.csetNamespacedDataObject, () => {
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.setNamespacedDataObject function, with a valid data.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.setNamespacedDataObject function, with an invalid string inputMetaData.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.setNamespacedDataObject function, with an invalid integer data.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.setNamespacedDataObject function, with an invalid boolean data.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.setNamespacedDataObject function, with an invalid NaN data.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.setNamespacedDataObject function, with an invalid string data.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.setNamespacedDataObject function, with an invalid integer inputMetaData.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.setNamespacedDataObject function, with an invalid boolean inputMetaData.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules.rules.arrayParsing.dataArrayParsing.setNamespacedDataObject function, with an invalid undefined data.
    * @author Json Howard
    * @date 2023/04/19
    */
