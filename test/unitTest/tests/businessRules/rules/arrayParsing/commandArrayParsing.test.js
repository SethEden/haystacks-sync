...
describe(tst_con.csolveLehmerCode, () => {
    ...
    * @description Tests the businessRules rules arrayParsing commandArrayParsing function solveLehmerCode with a invalid string data.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules rules arrayParsing commandArrayParsing function solveLehmerCode with a invalid string inputMetaData.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules rules arrayParsing commandArrayParsing function solveLehmerCode with a invalid integer data.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules rules arrayParsing commandArrayParsing function solveLehmerCode with a invalid boolean data.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules rules arrayParsing commandArrayParsing function solveLehmerCode with a invalid integer inputMetaData.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules rules arrayParsing commandArrayParsing function solveLehmerCode with a invalid boolean inputMetaData.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules rules arrayParsing commandArrayParsing function solveLehmerCode with a invalid undefined data.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules rules arrayParsing commandArrayParsing function solveLehmerCode with a invalid NaN data.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules rules arrayParsing commandArrayParsing function solveLehmerCode with a invalid undefined inputMetaData.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules rules arrayParsing commandArrayParsing function solveLehmerCode with a invalid NaN inputMetaData.
    * @author Json Howard
    * @date 2023/04/19
    */
...
describe(tst_con.crecursiveArrayExpansion, () => {
    ...
    * @description Tests the businessRules rules arrayParsing commandArrayParsing function recursiveArrayExpansion with a invalid string data.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules rules arrayParsing commandArrayParsing function recursiveArrayExpansion with a invalid string inputMetaData.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules rules arrayParsing commandArrayParsing function recursiveArrayExpansion with a invalid integer data.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules rules arrayParsing commandArrayParsing function recursiveArrayExpansion with a invalid boolean data.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules rules arrayParsing commandArrayParsing function recursiveArrayExpansion with a invalid integer inputMetaData.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules rules arrayParsing commandArrayParsing function recursiveArrayExpansion with a invalid boolean inputMetaData.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules rules arrayParsing commandArrayParsing function recursiveArrayExpansion with a invalid undefined inputMetaData.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules rules arrayParsing commandArrayParsing function recursiveArrayExpansion with a invalid NaN inputMetaData.
    * @author Json Howard
    * @date 2023/04/19
    */
...
describe(tst_con.cgetLehmerCodeValue, () => {
    ...
    * @description Tests the businessRules rules arrayParsing commandArrayParsing function getLehmerCodeValue with a invalid string data.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules rules arrayParsing commandArrayParsing function getLehmerCodeValue with a invalid string inputMetaData.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules rules arrayParsing commandArrayParsing function getLehmerCodeValue with a invalid integer data.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules rules arrayParsing commandArrayParsing function getLehmerCodeValue with a invalid boolean data.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules rules arrayParsing commandArrayParsing function getLehmerCodeValue with a invalid integer inputMetaData.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules rules arrayParsing commandArrayParsing function getLehmerCodeValue with a invalid boolean inputMetaData.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules rules arrayParsing commandArrayParsing function getLehmerCodeValue with a invalid undefiend data.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules rules arrayParsing commandArrayParsing function getLehmerCodeValue with a invalid NaN data.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules rules arrayParsing commandArrayParsing function getLehmerCodeValue with a invalid undefined inputMetaData.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules rules arrayParsing commandArrayParsing function getLehmerCodeValue with a invalid NaN inputMetaData.
    * @author Json Howard
    * @date 2023/04/19
    */
...
describe(tst_con.cgenerateCommandAliases, () => {
    ...
    * @description Tests the businessRules rules arrayParsing commandArrayParsing function getLehmerCodeValue with a invalid undefined data.
    * @author Json Howard
    * @date 2023/04/19
    */
...
describe(tst_con.caggregateCommandArguments, () => {
    ...
    * @description Tests the businessRules rules arrayParsing commandArrayParsing function aggregateCommandArguments with a invalid string data.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules rules arrayParsing commandArrayParsing function aggregateCommandArguments with a invalid string inputMetaData.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules rules arrayParsing commandArrayParsing function aggregateCommandArguments with a invalid integer data.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules rules arrayParsing commandArrayParsing function aggregateCommandArguments with a invalid boolean data.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules rules arrayParsing commandArrayParsing function aggregateCommandArguments with a invalid integer inputMetaData.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules rules arrayParsing commandArrayParsing function aggregateCommandArguments with a invalid boolean inputMetaData.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules rules arrayParsing commandArrayParsing function aggregateCommandArguments with a invalid undefiend data.
    * @author Json Howard
    * @date 2023/04/19
    */
    ...
    * @description Tests the businessRules rules arrayParsing commandArrayParsing function aggregateCommandArguments with a invalid NaN data.
    * @author Json Howard
    * @date 2023/04/19
    */
