...
describe(tst_con.csingleQuoteSwapAfterEquals, () => {
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.singleQuoteSwapAfterEquals function, with a valid data.
    * @author Json Howard
    * @date 2023/04/25
    */
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.singleQuoteSwapAfterEquals function, with an invalid string data.
    * @author Json Howard
    * @date 2023/04/25
    */
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.singleQuoteSwapAfterEquals function, with an invalid string inputMetaData.
    * @author Json Howard
    * @date 2023/04/25
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.singleQuoteSwapAfterEquals function, with an invalid integer data.
    * @author Json Howard
    * @date 2023/04/25
    */
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.singleQuoteSwapAfterEquals function, with an invalid boolean data.
    * @author Json Howard
    * @date 2023/04/25
    */
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.singleQuoteSwapAfterEquals function, with an invalid integer inputMetaData.
    * @author Json Howard
    * @date 2023/04/25
    */
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.singleQuoteSwapAfterEquals function, with an invalid boolean inputMetaData.
    * @author Json Howard
    * @date 2023/04/25
    */
...
describe(tst_con.cswapForwardSlashToBackSlash, () => {
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.swapForwardSlashToBackSlash function, with a valid data.
    * @author Json Howard
    * @date 2023/04/25
    */
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.swapForwardSlashToBackSlash function, with an invalid string data.
    * @author Json Howard
    * @date 2023/04/25
    */
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.swapForwardSlashToBackSlash function, with an invalid string inputMetaData.
    * @author Json Howard
    * @date 2023/04/25
    * @NOTE Commented out because meta data is not used.
    */
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.swapForwardSlashToBackSlash function, with an invalid integer data.
    * @author Json Howard
    * @date 2023/04/25
    */
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.swapForwardSlashToBackSlash function, with an invalid boolean data.
    * @author Json Howard
    * @date 2023/04/25
    */
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.swapForwardSlashToBackSlash function, with an invalid integer inputMetaData.
    * @author Json Howard
    * @date 2023/04/25
    */
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.swapForwardSlashToBackSlash function, with an invalid boolean inputMetaData.
    * @author Json Howard
    * @date 2023/04/25
    */
...
describe(tst_con.cswapBackSlashToForwardSlash, () => {
    ...
    * @description Tests the businessRules.rules.stringParsing.characterGeneration.swapBackSlashToForwardSlash function, with a valid data.
    * @author Json Howard
    * @date 2023/04/25
    */
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.swapBackSlashToForwardSlash function, with an invalid string data.
    * @author Json Howard
    * @date 2023/04/25
    */
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.swapBackSlashToForwardSlash function, with an invalid string inputMetaData.
    * @author Json Howard
    * @date 2023/04/25
    * @NOTE Commented out because meta data is not used.
    */
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.swapBackSlashToForwardSlash function, with an invalid integer data.
    * @author Json Howard
    * @date 2023/04/25
    */
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.swapBackSlashToForwardSlash function, with an invalid boolean data.
    * @author Json Howard
    * @date 2023/04/25
    */
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.swapBackSlashToForwardSlash function, with an invalid integer inputMetaData.
    * @author Json Howard
    * @date 2023/04/25
    */
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.swapBackSlashToForwardSlash function, with an invalid boolean inputMetaData.
    * @author Json Howard
    * @date 2023/04/25
    */
...
describe(tst_con.cswapDoubleForwardSlashToSingleForwardSlash, () => {
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.swapDoubleForwardSlashToSingleForwardSlash function, with a valid data.
    * @author Json Howard
    * @date 2023/04/25
    */
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.swapDoubleForwardSlashToSingleForwardSlash function, with an invalid string data.
    * @author Json Howard
    * @date 2023/04/25
    */
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.swapDoubleForwardSlashToSingleForwardSlash function, with an invalid string inputMetaData.
    * @author Json Howard
    * @date 2023/04/25
    * @NOTE Commented out because meta data is not used.
    */
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.swapDoubleForwardSlashToSingleForwardSlash function, with an invalid integer data.
    * @author Json Howard
    * @date 2023/04/25
    */
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.swapDoubleForwardSlashToSingleForwardSlash function, with an invalid boolean data.
    * @author Json Howard
    * @date 2023/04/25
    */
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.swapDoubleForwardSlashToSingleForwardSlash function, with an invalid integer inputMetaData.
    * @author Json Howard
    * @date 2023/04/25
    */
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.swapDoubleForwardSlashToSingleForwardSlash function, with an invalid boolean inputMetaData.
    * @author Json Howard
    * @date 2023/04/25
    */
...
describe(tst_con.cswapDoubleBackSlashToSingleBackSlash, () => {
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.swapDoubleBackSlashToSingleBackSlash function, with a valid data.
    * @author Json Howard
    * @date 2023/04/25
    */
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.swapDoubleBackSlashToSingleBackSlash function, with an invalid string data.
    * @author Json Howard
    * @date 2023/04/25
    */
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.swapDoubleBackSlashToSingleBackSlash function, with an invalid string inputMetaData.
    * @author Json Howard
    * @date 2023/04/25
    * @NOTE Commented out because meta data is not used.
    */
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.swapDoubleBackSlashToSingleBackSlash function, with an invalid integer data.
    * @author Json Howard
    * @date 2023/04/25
    */
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.swapDoubleBackSlashToSingleBackSlash function, with an invalid boolean data.
    * @author Json Howard
    * @date 2023/04/25
    */
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.swapDoubleBackSlashToSingleBackSlash function, with an invalid integer inputMetaData.
    * @author Json Howard
    * @date 2023/04/25
    */
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.swapDoubleBackSlashToSingleBackSlash function, with an invalid boolean inputMetaData.
    * @author Json Howard
    * @date 2023/04/25
    */
...
describe(tst_con.creplaceSpacesWithPlus, () => {
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.replaceSpacesWithPlus function, with a valid data.
    * @author Json Howard
    * @date 2023/04/25
    */
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.replaceSpacesWithPlus function, with an invalid string data.
    * @author Json Howard
    * @date 2023/04/25
    */
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.replaceSpacesWithPlus function, with an invalid string inputMetaData.
    * @author Json Howard
    * @date 2023/04/25
    * @NOTE Commented out because meta data is not used.
    */
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.replaceSpacesWithPlus function, with an invalid integer data.
    * @author Json Howard
    * @date 2023/04/25
    */
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.replaceSpacesWithPlus function, with an invalid boolean data.
    * @author Json Howard
    * @date 2023/04/25
    */
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.replaceSpacesWithPlus function, with an invalid integer inputMetaData.
    * @author Json Howard
    * @date 2023/04/25
    */
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.replaceSpacesWithPlus function, with an invalid boolean inputMetaData.
    * @author Json Howard
    * @date 2023/04/25
    */
...
describe(tst_con.creplaceColonWithUnderscore, () => {
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.replaceColonWithUnderscore function, with a valid data.
    * @author Json Howard
    * @date 2023/04/25
    */
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.replaceColonWithUnderscore function, with an invalid string data.
    * @author Json Howard
    * @date 2023/04/25
    */
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.replaceColonWithUnderscore function, with an invalid string inputMetaData.
    * @author Json Howard
    * @date 2023/04/25
    * @NOTE Commented out because meta data is not used.
    */
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.replaceColonWithUnderscore function, with an invalid integer data.
    * @author Json Howard
    * @date 2023/04/25
    */
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.replaceColonWithUnderscore function, with an invalid boolean data.
    * @author Json Howard
    * @date 2023/04/25
    */
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.replaceColonWithUnderscore function, with an invalid integer inputMetaData.
    * @author Json Howard
    * @date 2023/04/25
    */
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.replaceColonWithUnderscore function, with an invalid boolean inputMetaData.
    * @author Json Howard
    * @date 2023/04/25
    */
...
describe(tst_con.ccleanCarriageReturnFromString, () => {
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.cleanCarriageReturnFromString function, with a valid data.
    * @author Json Howard
    * @date 2023/04/25
    */
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.cleanCarriageReturnFromString function, with an invalid string data.
    * @author Json Howard
    * @date 2023/04/25
    */
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.cleanCarriageReturnFromString function, with an invalid string inputMetaData.
    * @author Json Howard
    * @date 2023/04/25
    * @NOTE Commented out because meta data is not used.
    */
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.cleanCarriageReturnFromString function, with an invalid integer data.
    * @author Json Howard
    * @date 2023/04/25
    */
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.cleanCarriageReturnFromString function, with an invalid boolean data.
    * @author Json Howard
    * @date 2023/04/25
    */
...
describe(tst_con.cconvertStringToLowerCase, () => {
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.convertStringToLowerCase function, with a valid data.
    * @author Json Howard
    * @date 2023/04/25
    */
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.convertStringToLowerCase function, with an invalid string data.
    * @author Json Howard
    * @date 2023/04/25
    */
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.convertStringToLowerCase function, with an invalid string inputMetaData.
    * @author Json Howard
    * @date 2023/04/25
    * @NOTE Commented out because meta data is not used.
    */
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.convertStringToLowerCase function, with an invalid integer data.
    * @author Json Howard
    * @date 2023/04/25
    */
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.convertStringToLowerCase function, with an invalid boolean data.
    * @author Json Howard
    * @date 2023/04/25
    */
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.convertStringToLowerCase function, with an invalid integer inputMetaData.
    * @author Json Howard
    * @date 2023/04/25
    */
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.convertStringToLowerCase function, with an invalid boolean inputMetaData.
    * @author Json Howard
    * @date 2023/04/25
    */
...
describe(tst_con.cconvertStringToUpperCase, () => {
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.convertStringToUpperCase function, with a valid data.
    * @author Json Howard
    * @date 2023/04/25
    */
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.convertStringToUpperCase function, with an invalid string data.
    * @author Json Howard
    * @date 2023/04/25
    */
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.convertStringToUpperCase function, with an invalid string inputMetaData.
    * @author Json Howard
    * @date 2023/04/25
    * @NOTE Commented out because meta data is not used.
    */
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.convertStringToUpperCase function, with an invalid integer data.
    * @author Json Howard
    * @date 2023/04/25
    */
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.convertStringToUpperCase function, with an invalid boolean data.
    * @author Json Howard
    * @date 2023/04/25
    */
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.convertStringToUpperCase function, with an invalid integer inputMetaData.
    * @author Json Howard
    * @date 2023/04/25
    */
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.convertStringToUpperCase function, with an invalid boolean inputMetaData.
    * @author Json Howard
    * @date 2023/04/25
    */
...
describe(tst_con.cdoesStringContainUpperCaseCharacter, () => {
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.doesStringContainUpperCaseCharacter function, with a valid data.
    * @author Json Howard
    * @date 2023/04/25
    */
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.doesStringContainUpperCaseCharacter function, with an invalid string data.
    * @author Json Howard
    * @date 2023/04/25
    */
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.doesStringContainUpperCaseCharacter function, with an invalid string inputMetaData.
    * @author Json Howard
    * @date 2023/04/25
    * @NOTE Commented out because meta data is not used.
    */
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.doesStringContainUpperCaseCharacter function, with an invalid integer data.
    * @author Json Howard
    * @date 2023/04/25
    */
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.doesStringContainUpperCaseCharacter function, with an invalid boolean data.
    * @author Json Howard
    * @date 2023/04/25
    */
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.doesStringContainUpperCaseCharacter function, with an invalid integer inputMetaData.
    * @author Json Howard
    * @date 2023/04/25
    */
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.doesStringContainUpperCaseCharacter function, with an invalid boolean inputMetaData.
    * @author Json Howard
    * @date 2023/04/25
    */
...
describe(tst_con.cdoesStringContainLowerCaseCharacter, () => {
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.doesStringContainLowerCaseCharacter function, with a valid data.
    * @author Json Howard
    * @date 2023/04/25
    */
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.doesStringContainLowerCaseCharacter function, with an invalid string data.
    * @author Json Howard
    * @date 2023/04/25
    */
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.doesStringContainLowerCaseCharacter function, with an invalid string inputMetaData.
    * @author Json Howard
    * @date 2023/04/25
    * @NOTE Commented out because meta data is not used.
    */
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.doesStringContainLowerCaseCharacter function, with an invalid integer data.
    * @author Json Howard
    * @date 2023/04/25
    */
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.doesStringContainLowerCaseCharacter function, with an invalid boolean data.
    * @author Json Howard
    * @date 2023/04/25
    */
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.doesStringContainLowerCaseCharacter function, with an invalid integer inputMetaData.
    * @author Json Howard
    * @date 2023/04/25
    */
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.doesStringContainLowerCaseCharacter function, with an invalid boolean inputMetaData.
    * @author Json Howard
    * @date 2023/04/25
    */
...
describe(tst_con.cisFirstCharacterLowerCase, () => {
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.isFirstCharacterLowerCase function, with a valid data.
    * @author Json Howard
    * @date 2023/04/25
    */
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.isFirstCharacterLowerCase function, with an invalid string data.
    * @author Json Howard
    * @date 2023/04/25
    */
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.isFirstCharacterLowerCase function, with an invalid string inputMetaData.
    * @author Json Howard
    * @date 2023/04/25
    * @NOTE Commented out because meta data is not used.
    */
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.isFirstCharacterLowerCase function, with an invalid integer data.
    * @author Json Howard
    * @date 2023/04/25
    */
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.isFirstCharacterLowerCase function, with an invalid boolean data.
    * @author Json Howard
    * @date 2023/04/25
    */
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.isFirstCharacterLowerCase function, with an invalid integer inputMetaData.
    * @author Json Howard
    * @date 2023/04/25
    */
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.isFirstCharacterLowerCase function, with an invalid boolean inputMetaData.
    * @author Json Howard
    * @date 2023/04/25
    */
...
describe(tst_con.cisFirstCharacterUpperCase, () => {
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.isFirstCharacterUpperCase function, with a valid data.
    * @author Json Howard
    * @date 2023/04/25
    */
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.isFirstCharacterUpperCase function, with an invalid string data.
    * @author Json Howard
    * @date 2023/04/25
    */
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.isFirstCharacterUpperCase function, with an invalid string inputMetaData.
    * @author Json Howard
    * @date 2023/04/25
    * @NOTE Commented out because meta data is not used.
    */
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.isFirstCharacterUpperCase function, with an invalid integer data.
    * @author Json Howard
    * @date 2023/04/25
    */
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.isFirstCharacterUpperCase function, with an invalid boolean data.
    * @author Json Howard
    * @date 2023/04/25
    */
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.isFirstCharacterUpperCase function, with an invalid integer inputMetaData.
    * @author Json Howard
    * @date 2023/04/25
    */
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.isFirstCharacterUpperCase function, with an invalid boolean inputMetaData.
    * @author Json Howard
    * @date 2023/04/25
    */
...
describe(tst_con.creplaceCharacterAtIndexOfString, () => {
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.replaceCharacterAtIndexOfString function, with a valid data.
    * @author Json Howard
    * @date 2023/04/25
    */
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.replaceCharacterAtIndexOfString function, with an invalid string inputMetaData.
    * @author Json Howard
    * @date 2023/04/25
    */
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.replaceCharacterAtIndexOfString function, with an invalid integer data.
    * @author Json Howard
    * @date 2023/04/25
    */
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.replaceCharacterAtIndexOfString function, with an invalid boolean data.
    * @author Json Howard
    * @date 2023/04/25
    */
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.replaceCharacterAtIndexOfString function, with an invalid integer inputMetaData.
    * @author Json Howard
    * @date 2023/04/25
    */
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.replaceCharacterAtIndexOfString function, with an invalid boolean inputMetaData.
    * @author Json Howard
    * @date 2023/04/25
    */
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.replaceCharacterAtIndexOfString function, with an invalid undefined data.
    * @author Json Howard
    * @date 2023/04/25
    */
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.replaceCharacterAtIndexOfString function, with an invalid NaN data.
    * @author Json Howard
    * @date 2023/04/25
    */
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.replaceCharacterAtIndexOfString function, with an invalid undefined inputMetaData.
    * @author Json Howard
    * @date 2023/04/25
    */
    ...
    * @description Tests the businessRules.rules.stringParsing.characterStringParsing.replaceCharacterAtIndexOfString function, with an invalid NaN inputMetaData.
    * @author Json Howard
    * @date 2023/04/25
    */
