...
describe(tst_con.cparseBusinessRuleArgument, () => {
   ...
   * @description Tests the businessRules.rules.lexicalAnalyzer.parseBusinessRuleArgument function, with a valid input.
   * @author Json Howard
   * @date 2023/05/05
   */
   ...
   * @description Tests the businessRules.rules.lexicalAnalyzer.parseBusinessRuleArgument function, with a array string input.
   * @author Json Howard
   * @date 2023/05/05
   */
   ...
   * @description Tests the businessRules.rules.lexicalAnalyzer.parseBusinessRuleArgument function, with a array integer input.
   * @author Json Howard
   * @date 2023/05/05
   */
   ...
   * @description Tests the businessRules.rules.lexicalAnalyzer.parseBusinessRuleArgument function, with a array boolean input.
   * @author Json Howard
   * @date 2023/05/05
   */
   ...
   * @description Tests the businessRules.rules.lexicalAnalyzer.parseBusinessRuleArgument function, with a array object input.
   * @author Json Howard
   * @date 2023/05/05
   */
   ...
   * @description Tests the businessRules.rules.lexicalAnalyzer.parseBusinessRuleArgument function, with invalid string input.
   * @author Json Howard
   * @date 2023/05/05
   */
   ...
   * @description Tests the businessRules.rules.lexicalAnalyzer.parseBusinessRuleArgument function, with invalid integer input.
   * @author Json Howard
   * @date 2023/05/05
   */
   ...
   * @description Tests the businessRules.rules.lexicalAnalyzer.parseBusinessRuleArgument function, with invalid boolean input.
   * @author Json Howard
   * @date 2023/05/05
   */
   ...
   * @description Tests the businessRules.rules.lexicalAnalyzer.parseBusinessRuleArgument function, with invalid integer inputMetaData.
   * @author Json Howard
   * @date 2023/05/05
   */
   ...
   * @description Tests the businessRules.rules.lexicalAnalyzer.parseBusinessRuleArgument function, with invalid boolean inputMetaData.
   * @author Json Howard
   * @date 2023/05/05
   */
   ...
   * @description Tests the businessRules.rules.lexicalAnalyzer.parseBusinessRuleArgument function, with invalid undefined input.
   * @author Json Howard
   * @date 2023/05/05
   */
   ...
   * @description Tests the businessRules.rules.lexicalAnalyzer.parseBusinessRuleArgument function, with invalid NaN input.
   * @author Json Howard
   * @date 2023/05/05
   */
   ...
   * @description Tests the businessRules.rules.lexicalAnalyzer.parseBusinessRuleArgument function, with invalid undefined inputMetaData.
   * @author Json Howard
   * @date 2023/05/05
   */
   ...
   * @description Tests the businessRules.rules.lexicalAnalyzer.parseBusinessRuleArgument function, with invalid NaN inputMetaData.
   * @author Json Howard
   * @date 2023/05/05
   */
...
describe(tst_con.canalyzeArgument, () => {
   ...
   * @description Tests the businessRules.rules.lexicalAnalyzer.analyzeArgument function, with a valid input.
   * @author Json Howard
   * @date 2023/05/05
   */
   ...
   * @description Tests the businessRules.rules.lexicalAnalyzer.analyzeArgument function, with an invalid string input.
   * @author Json Howard
   * @date 2023/05/05
   */
   ...
   * @description Tests the businessRules.rules.lexicalAnalyzer.analyzeArgument function, with an invalid string inputMetaData.
   * @author Json Howard
   * @date 2023/05/05
   */
   ...
   * @description Tests the businessRules.rules.lexicalAnalyzer.analyzeArgument function, with an invalid integer input.
   * @author Json Howard
   * @date 2023/05/05
   */
   ...
   * @description Tests the businessRules.rules.lexicalAnalyzer.analyzeArgument function, with an invalid boolean input.
   * @author Json Howard
   * @date 2023/05/05
   */
   ...
   * @description Tests the businessRules.rules.lexicalAnalyzer.analyzeArgument function, with an invalid integer inputMetaData.
   * @author Json Howard
   * @date 2023/05/05
   */
   ...
   * @description Tests the businessRules.rules.lexicalAnalyzer.analyzeArgument function, with an invalid boolean inputMetaData.
   * @author Json Howard
   * @date 2023/05/05
   */
...
describe(tst_con.canalyzeForRegularExpression, () => {
   ...
   * @description Tests the businessRules.rules.lexicalAnalyzer.analyzeForRegularExpression function, with a valid input.
   * @author Json Howard
   * @date 2023/05/05
   */
   ...
   * @description Tests the businessRules.rules.lexicalAnalyzer.analyzeForRegularExpression function, with an invalid string input.
   * @author Json Howard
   * @date 2023/05/05
   */
   ...
   * @description Tests the businessRules.rules.lexicalAnalyzer.analyzeForRegularExpression function, with an invalid string inputMetaData.
   * @author Json Howard
   * @date 2023/05/05
   */
   ...
   * @description Tests the businessRules.rules.lexicalAnalyzer.analyzeForRegularExpression function, with an invalid integer input.
   * @author Json Howard
   * @date 2023/05/05
   */
   ...
   * @description Tests the businessRules.rules.lexicalAnalyzer.analyzeForRegularExpression function, with an invalid boolean input.
   * @author Json Howard
   * @date 2023/05/05
   */
   ...
   * @description Tests the businessRules.rules.lexicalAnalyzer.analyzeForRegularExpression function, with an invalid integer inputMetaData.
   * @author Json Howard
   * @date 2023/05/05
   */
   ...
   * @description Tests the businessRules.rules.lexicalAnalyzer.analyzeForRegularExpression function, with an invalid boolean inputMetaData.
   * @author Json Howard
   * @date 2023/05/05
   */
...
describe(tst_con.cparseArgumentAsRegularExpression, () => {
   ...
   * @description Tests the businessRules.rules.lexicalAnalyzer.parseArgumentAsRegularExpression function, with a valid input.
   * @author Json Howard
   * @date 2023/05/05
   */
   ...
   * @description Tests the businessRules.rules.lexicalAnalyzer.parseArgumentAsRegularExpression function, with an invalid string input.
   * @author Json Howard
   * @date 2023/05/05
   */
   ...
   * @description Tests the businessRules.rules.lexicalAnalyzer.parseArgumentAsRegularExpression function, with an invalid string inputMetaData.
   * @author Json Howard
   * @date 2023/05/05
   */
   ...
   * @description Tests the businessRules.rules.lexicalAnalyzer.parseArgumentAsRegularExpression function, with an invalid integer input.
   * @author Json Howard
   * @date 2023/05/05
   */
   ...
   * @description Tests the businessRules.rules.lexicalAnalyzer.parseArgumentAsRegularExpression function, with an invalid boolean input.
   * @author Json Howard
   * @date 2023/05/05
   */
   ...
   * @description Tests the businessRules.rules.lexicalAnalyzer.parseArgumentAsRegularExpression function, with an invalid integer inputMetaData.
   * @author Json Howard
   * @date 2023/05/05
   */
   ...
   * @description Tests the businessRules.rules.lexicalAnalyzer.parseArgumentAsRegularExpression function, with an invalid boolean inputMetaData.
   * @author Json Howard
   * @date 2023/05/05
   */
...
describe(tst_con.cparseArgumentAsArray, () => {
   ...
   * @description Tests the businessRules.rules.lexicalAnalyzer.parseArgumentAsArray function, with a valid input.
   * @author Json Howard
   * @date 2023/05/05
   */
   ...
   * @description Tests the businessRules.rules.lexicalAnalyzer.parseArgumentAsArray function, with an invalid string input.
   * @author Json Howard
   * @date 2023/05/05
   */
   ...
   * @description Tests the businessRules.rules.lexicalAnalyzer.parseArgumentAsArray function, with an invalid string inputMetaData.
   * @author Json Howard
   * @date 2023/05/05
   */
   ...
   * @description Tests the businessRules.rules.lexicalAnalyzer.parseArgumentAsArray function, with an invalid integer input.
   * @author Json Howard
   * @date 2023/05/05
   */
   ...
   * @description Tests the businessRules.rules.lexicalAnalyzer.parseArgumentAsArray function, with an invalid boolean input.
   * @author Json Howard
   * @date 2023/05/05
   */
   ...
   * @description Tests the businessRules.rules.lexicalAnalyzer.parseArgumentAsArray function, with an invalid integer inputMetaData.
   * @author Json Howard
   * @date 2023/05/05
   */
   ...
   * @description Tests the businessRules.rules.lexicalAnalyzer.parseArgumentAsArray function, with an invalid boolean inputMetaData.
   * @author Json Howard
   * @date 2023/05/05
   */
...
describe(tst_con.cremoveStringLiteralTagsFromArray, () => {
   ...
   * @description Tests the businessRules.rules.lexicalAnalyzer.removeStringLiteralTagsFromArray function, with an invalid string input.
   * @author Json Howard
   * @date 2023/05/05
   */
   ...
   * @description Tests the businessRules.rules.lexicalAnalyzer.removeStringLiteralTagsFromArray function, with an invalid string inputMetaData.
   * @author Json Howard
   * @date 2023/05/05
   */
   ...
   * @description Tests the businessRules.rules.lexicalAnalyzer.removeStringLiteralTagsFromArray function, with an invalid integer input.
   * @author Json Howard
   * @date 2023/05/05
   */
   ...
   * @description Tests the businessRules.rules.lexicalAnalyzer.removeStringLiteralTagsFromArray function, with an invalid boolean input.
   * @author Json Howard
   * @date 2023/05/05
   */
   ...
   * @description Tests the businessRules.rules.lexicalAnalyzer.removeStringLiteralTagsFromArray function, with an invalid integer inputMetaData.
   * @author Json Howard
   * @date 2023/05/05
   */
   ...
   * @description Tests the businessRules.rules.lexicalAnalyzer.removeStringLiteralTagsFromArray function, with an invalid boolean inputMetaData.
   * @author Json Howard
   * @date 2023/05/05
   */
   ...
   * @description Tests the businessRules.rules.lexicalAnalyzer.removeStringLiteralTagsFromArray function, with an invalid NaN input.
   * @author Json Howard
   * @date 2023/05/05
   */
