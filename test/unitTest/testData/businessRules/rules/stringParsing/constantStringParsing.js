...
/**
 * @function xmlPath
 * @description get xml path to are used constantStringParsing.test.js for unit test
 * @author Json Howard
 * @date 2023/04/17
 */
 ...
 * @description get xml hive path to are used constantStringParsing.test.js for unit test
 * @author Json Howard
 * @date 2023/04/17
 */
